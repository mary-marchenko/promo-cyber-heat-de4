(function () {
    ...
    const apiURL = 'https://allwin-prom.pp.ua/api_cyber_heat_ne'
    ...
    const mainPage = document.querySelector(".cyberHeat"),
    ...
    function hideLoader(){
        ...
        document.querySelectorAll('.decor__arm').forEach(arm => arm.classList.add('animate-appear'))
    }
    ...
    //  anim for decor__arm
    document.querySelectorAll('.decor__arm').forEach(arm => {
